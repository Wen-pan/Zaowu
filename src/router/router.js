...
export default new Router({
  ...
  routes: [
    ...
    {
      path: '/Goosdetail/:Goosdetailid',
      name: 'Goosdetail',
      meta:{
        footShow:true
      },
      component: () => import(/* webpackChunkName: "Goosdetail" */ '@/views/kind/detail/Goosdetail.vue')
    },
    {
      path: '/Commodity',
      name: 'commodity',
      ...
      component: () => import(/* webpackChunkName: "Commodity" */ '@/views/kind/detail/components/Commodity.vue')
    },
    {
      path: '/Shopping/:id/:cname/:ename/:money',
      name: 'Shopping',
      meta:{
        footShow:false
      },
      component: () => import(/* webpackChunkName: "Shopping" */ '@/views/kind/detail/components/Shopping.vue')
    },
    {
      path: '/Cart',
      name: 'Cart',
      ...
      component: () => import(/* webpackChunkName: "Cart" */ '@/views/kind/detail/components/Cart.vue')
    },
    {
      path:'*',
      redirect:'/home'
